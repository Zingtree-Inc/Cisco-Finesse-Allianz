        ...
        handleNewDialog = function (dialog) {
            ...
            if (user.getExtension() != dialog.getFromAddress()) {
                ...
                if (Treeid != "") {
                    ...
                    $("#contentPage").attr("src", "" + domainName + "/deploy/tree.php?agent_mode=1&tree_id=" + Treeid + "&apikey=" + apiKey + "&show_history=" + showHistory + "&source="+user.getLastName()+""+querystring+"");
